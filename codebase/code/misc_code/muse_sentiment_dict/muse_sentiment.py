...
sentiment_dict={
	...
	"superlative":["brilliant","super","superb","beautiful","exquisite","astonishing","amazing","amazement","mindblowing","astounding","outstanding","astonish","astonished","fantastic","fabulous","electrifying","electrified","adulation","excellent","terrific","genius","priceless","rave","ravishing","gush","awesome","awe inspiring","awe-struck","awestruck","preeminent","pre eminent","standing ovation","gorgeous","marvel","marvellous","marvelous","stupendous","stunning","ooh","oooh","ooooh"],

	"gratitude":["grateful","gratitude","generous","heartwarming","heart warming"],

	"pride":["pride","proud","brag","bragging","bragged"],

	"joy":["joy","joyous","happiness","euphoria","high spirits","lovely","wonderful","gleeful","glad","thank god","thank goodness","good news","rhapsodic","ecstasy","enraptured","ecstatic","jubilation","festivity","celebration","celebrate","cloud nine","rapture","blissful","thrill","excited"],

	"surprise":["surprise","surprised","surprising","unusual","incredible","astound","astonish","unbelievable"],

	"pos_surprise":["remarkable","remarkably","omg","strange"],

	"wow":["wow"],

	"humor":["joke","funny","slapstick","comedy","humor","humour","haha","hahaha","ha ha","lol","hilarious"],

	"milestones":["milestones","centennial","anniversary","birthday","graduation","convocation","commencement","goodbye","ceremony","ceremonial"],

	"memories":["memories","remember","memoir","memoirs","memorable","unforgettable","reminiscence","remembrance"],

	"confidential":["confide","confided","confidential","secret","secrecy","secretly","secrets","don't tell"],

	"life_event":["marriage","marry","married","divorce","divorced","bereaved","bereavement","death","memorium","memoriam","obituary","obit","memorial","funeral","died","dying","fatal","pass away","born","birth"],
	...
	"love":["beloved","valentine","romance","romantic","sweetheart","sweetie","sweetiepie","darling","love"],
	...
	"expletives":["goddamn","goddam","gaddamit","damn","fuck","f*ck","fucking","fucked","fucks","fucker","sonofabitch","wtf","mofo"],

	"sadness":["cry","crying","sad","sadly","saddened","sadness","bleak","ouch","gloomy","crappy","crushed","distress","suffocate","lonely","rejected","pain","pained","morose","agony","anguish","dismay","dismayed","sympathy","bad news"],

	"conflict":["fault","mend fences","contrite","contrition","struggle","complaint","refuse","refusal","disagree","disagreement","don't trust"],
