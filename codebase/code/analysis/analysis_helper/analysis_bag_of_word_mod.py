...
# File:         analysis_bag_of_word_mod
# Purpose:      Module - Define bag of words analysis functions
...
def word_bag(msg_unigram, msg_bigram, word_dictionary, english):
...
def sentiment_word_bag(msg_unigram, msg_bigram, english, dict_path=sentiment_dict_path):
	...
	# process
	sentiment_word_bag_count, sentiment_word_bag_set, sentiment_word_bag_pos, sentiment_word_bag_indic = word_bag(msg_unigram, msg_bigram, sentiment_dict, english)
...
def pos_word_bag(msg_pos_dict, english, dict_path=pos_dict_path):
#---------------------------------------------#
	...
	# process
	pos_word_bag_count, pos_word_bag_set, pos_word_bag_pos, pos_word_bag_indic = word_bag(msg_pos,[], pos_dict, english)
