...
# File:         analysis_contact_mod
# Purpose:      Module - Define cleaning analysis functions
...
def contact_list(msg_data, user_email):
	...
	agg_contact_df             = global_fun_mod.df_sort(agg_contact_df, ['freq_agg'], [True])
	...
	## omit user
	agg_contact_df             = agg_contact_df[~agg_contact_df['contact'].str.contains(user_email)]
