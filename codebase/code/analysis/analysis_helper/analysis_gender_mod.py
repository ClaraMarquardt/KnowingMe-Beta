...
# File:         analysis_gender_mod
# Purpose:      Module - Define gender analysis functions
...
def gender_labeler(contact_list,contact_email, database_filepath=gender_path):
